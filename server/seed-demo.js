  ...
  try {
    ...
    if (!restaurant) {
      restaurant = new Restaurant({
        ...
        description: 'A demo restaurant with tasty items for testing and presentation.',
        address: '123 Demo Street',
        city: 'Demo City',
        phone: '+1234567890',
    ...
    const demoItems = [
      {
        ...
        description: 'A juicy burger with fresh lettuce, tomato, cheese, and our special sauce.',
        price: 9.99,
        category: 'Burgers',
      ...
      },
      {
        ...
        description: 'Classic pizza topped with mozzarella, fresh basil, and tomato sauce.',
        price: 12.5,
        category: 'Pizza',
    ...
    for (const itemData of demoItems) {
      const existingItem = await MenuItem.findOne({ restaurantId: restaurant._id, name: itemData.name });
      if (!existingItem) {
        const menuItem = new MenuItem({ restaurantId: restaurant._id, ...itemData });
        await menuItem.save();
